...
$(document).ready(function() { // CLICK LOGO TO GO THE HOMEPAGE
    ...
    if(flightQueryJson) {
        ...
        const origin = capitalize(flightData.destination);
        const destination = capitalize(flightData.origin);
        const departureDate = new Date(flightData.returnDate);
                    ...
                    const text = `<div class="flight-details-container"> 
                                    <div class="flight-details">
                                        <div class="flight-details-row">
                                            <div class="detail row1">${origin}</div>
                                            <div class="detail row1">>>>>>>>>></div>
                                            <div class="detail row1">${destination}</div>
                                        ...
                                        <div class="flight-details-row">
                                            <div class="detail row2">${departureDate.toLocaleString('en-US',options)}</div>
                                            <div class="detail row2">

                                            </div>
                                            <div class="detail row2">${arrivalDate}</div>
                                            <div class="detail row2">
